...
class AutoridadesController {
    ...
    async listarAutoridades(req, res) {
        try {
            const resultado = await autoridadesService.listarAutoridades();
    ...
    async obtenerAutoridadPorId(req, res) {
        try {
            const { id } = req.params;
            const resultado = await autoridadesService.obtenerAutoridadPorId(id);
    ...
    async crearAutoridad(req, res) {
        try {
            ...
            const resultado = await autoridadesService.crearAutoridad(datosAutoridad);
    ...
    async actualizarAutoridad(req, res) {
        try {
            ...
            const resultado = await autoridadesService.actualizarAutoridad(id, datosActualizados);

            // ✅ OBTENER LA AUTORIDAD ACTUALIZADA PARA DEVOLVERLA
            const autoridadActualizada = await autoridadesService.obtenerAutoridadPorId(id);
    ...
    async eliminarAutoridad(req, res) {
        try {
            const { id } = req.params;
            const resultado = await autoridadesService.eliminarAutoridad(id);
    ...
    async obtenerAutoridadesParaFirmas(req, res) {
        try {
            const resultado = await autoridadesService.obtenerAutoridadesParaFirmas();
    ...
    async actualizarOrdenesMultiples(req, res) {
        try {
            ...
            const resultado = await autoridadesService.actualizarOrdenesMultiples(actualizaciones);
