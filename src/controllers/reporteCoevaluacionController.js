...
class ReporteCoevaluacionController {
    ...
    async generarReporte(req, res) {
        try {
            ...
            const pdfBuffer = await reporteCoevaluacionService.generarReportePDF(parseInt(idPeriodo), cedula);
    ...
    async generarReporteExcel(req, res) {
        try {
            ...
            // Pasar la cédula del coordinador al servicio de Excel
            const excelBuffer = await reporteCoevaluacionExcelService.generarReporteExcel(parseInt(idPeriodo), cedula);
    ...
    async generarReportePorCarrera(req, res) {
        try {
            ...
            // Generar reporte por carrera específica
            const pdfBuffer = await reporteCoevaluacionService.generarReportePDFPorCarrera(parseInt(idPeriodo), parseInt(idCarrera));
    ...
    async generarReporteExcelPorCarrera(req, res) {
        try {
            ...
            const excelBuffer = await reporteCoevaluacionExcelService.generarReporteExcelPorCarrera(parseInt(idPeriodo), parseInt(idCarrera));
    ...
    async generarReporteExcelGeneral(req, res) {
        try {
            ...
            const excelBuffer = await reporteCoevaluacionExcelService.generarReporteExcelGeneral(parseInt(idPeriodo));
