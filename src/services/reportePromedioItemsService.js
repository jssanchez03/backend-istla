...
class ReportePromedioItemsService {
    ...
    async generarPDF(datosPromedio, periodo) {
        return new Promise((resolve, reject) => {
            try {
                ...
                // Agregar firma de la vicerrectora al final
                this.agregarFirmaVicerrectora(doc);
    ...
    // Agregar firma de la vicerrectora centrada al final
    agregarFirmaVicerrectora(doc) {
        ...
        doc.text(nombre, marginX, startY + 10, {
        ...
        doc.text(cargo, marginX, startY + 25, {
            width: availableWidth,
            align: 'center'
        });
    }
